...
[![Open T4 in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Changnt1301/K4-Track3-Day22-DPO-ORPO-Alignment-2A202601294-NguyenThuyTrang/blob/main/colab/Lab22_DPO_T4.ipynb)
...
```bash
git clone https://github.com/Changnt1301/K4-Track3-Day22-DPO-ORPO-Alignment-2A202601294-NguyenThuyTrang.git
cd K4-Track3-Day22-DPO-ORPO-Alignment-2A202601294-NguyenThuyTrang
...
1. **Fork hoặc copy repo này lên GitHub account của bạn**, set repo **public**.
   ```bash
   git init -b main
   git remote add origin https://github.com/Changnt1301/K4-Track3-Day22-DPO-ORPO-Alignment-2A202601294-NguyenThuyTrang.git
   ```
